...
#ifndef PROPERTYCONTROLINTEGER_H
#define PROPERTYCONTROLINTEGER_H
...
class PropertyControlInteger : public QWidget
{
    Q_OBJECT

public:
    explicit PropertyControlInteger(
...
#endif // PROPERTYCONTROLINTEGER_H
